...
stores_js_path=components/js/stores/stores.js
stores_css_path=components/css/stores.css
...
append_js $sc_web_path/templates/components.html $stores_js_path
append_css $sc_web_path/templates/components.html $stores_css_path
